...
pub1 = PublishingHouse.create(name: "ABC Publisher", discount: 40.0)
pub2 = PublishingHouse.create(name: "Acme Publishing House", discount: 50.0)
pub3 = PublishingHouse.create(name: "Foobar Corporation", discount: 55.0)

author1 = Author.create(name: "James Jackson", biography: "My Biography")
author2 = Author.create(name: "Roberta Rock", biography: "My Biography")
author3 = Author.create(name: "Daniel Duck", biography: "My Biography")
author4 = Author.create(name: "Amanda Djidjinski", biography: "My Biography")
author5 = Author.create(name: "Zoe Zack", biography: "My Biography")
author6 = Author.create(name: "Bill Burray", biography: "My Biography")
author7 = Author.create(name: "Charlie Chuck", biography: "My Biography")
